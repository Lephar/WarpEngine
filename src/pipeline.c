...
void createPipelineLayout() {
    ...
    descriptorSetLayouts[3] = lightingDescriptorPool.layout;
    descriptorSetLayouts[4] = materialDescriptorPool.layout;
    descriptorSetLayouts[5] = samplerDescriptorPool.layout;
...
void bindPipeline(uint32_t framebufferSetIndex, uint32_t framebufferIndex) {
    ...
    vkCmdBindDescriptorSets(framebuffer->renderCommandBuffer, VK_PIPELINE_BIND_POINT_GRAPHICS, pipelineLayout, 0, 1, &storageDescriptorSet, 0, nullptr);
}
