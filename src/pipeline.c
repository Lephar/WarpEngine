...
void createPipelineLayout() {
    ...
    for(uint32_t layoutIndex = 0; layoutIndex < descriptorSetLayoutCount; layoutIndex++) {
        descriptorSetLayouts[layoutIndex] = descriptorPoolReferences[layoutIndex]->layout;
    }
